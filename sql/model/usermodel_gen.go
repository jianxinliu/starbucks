...
type (
	...
	User struct {
		...
		UserType  sql.NullString `db:"user_type"` // 用户类型 normal, vip……
	}
)
...
func (m *defaultUserModel) Insert(ctx context.Context, data *User) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.DeletedAt, data.UserId, data.UserName, data.Password, data.UserType)
	}, starbucksUserIdKey, starbucksUserUserIdKey)
	return ret, err
}
...
func (m *defaultUserModel) Update(ctx context.Context, newData *User) error {
	...
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, newData.DeletedAt, newData.UserId, newData.UserName, newData.Password, newData.UserType, newData.Id)
	}, starbucksUserIdKey, starbucksUserUserIdKey)
	return err
}
